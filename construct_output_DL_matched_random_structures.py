...
from baseline_conditions_DL_matched_random_structures import *
                ...
                if ls_random:
                    ...
                    for edgex in treex.edges:
                        if not edgex[0]==root:
                            ...
                            results1 = open('DL_matched_random_structures.csv','a')
                    ...
                    for edgey in tree.edges:
                        if not edgey[0]==0:
                            ...
                            results2 = open('DL_matched_random_structures.csv','a')
